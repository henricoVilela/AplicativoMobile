  ...
  { TUser }
    ...
    TUser = Class
      ...
      public
         ...
         function RequestContract(id:string;TypeStatus:string; qtd:string; valor:string; idLocatario:string):string;
...
function TUser.RequestContract(id:string;TypeStatus:string; qtd:string; valor:string; idLocatario:string):string;
begin
     Result:= HttpGet(ReplaceChar('http://'+SERVER+'//cgi-bin/cgiresidency.exe/alugar?task=solicitarcontrato&status='+TypeStatus+'&id='+id+'&qtd='+qtd+'&valor='+valor+'&idLocatario='+idLocatario,' ','+'));
end;
